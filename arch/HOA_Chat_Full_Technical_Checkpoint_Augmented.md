...
4. Output must conform to 3-line format:  
   - **Line 1** → Direct answer (Yes/No/Not allowed).  
   - **Line 2** → Controlling authority summary.  
   - **Line 3** → “Citation:” with sources in authority order.
